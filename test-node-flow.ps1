...
Write-Host '4. Trabajadores iniciales...'
$trabajadoresInicial = Invoke-RestMethod -Method GET `
...
Write-Host '9. Desactivar trabajador otra vez...'
$desactivado2 = Invoke-RestMethod -Method PATCH `
  -Uri "$baseUrl/trabajadores/$id/desactivar" `
  -Headers $headers

Write-Host '10. Eliminar trabajador...'
$eliminado = Invoke-RestMethod -Method DELETE `
  -Uri "$baseUrl/trabajadores/$id" `
  -Headers $headers

Write-Host '11. Verificar eliminación...'
